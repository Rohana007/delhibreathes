...
import { Map, ArrowRight, Flame, TrendingUp } from 'lucide-react';
...
export default function HotspotsCard() {
  ...
  const handleNavigate = () => {
    navigate('/policy-dashboard/hotspots');
  };
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)' }}>
            <Map className="w-6 h-6" style={{ color: '#EF4444' }} />
          </div>
          <div>
            ...
            <p className="text-sm" style={{ color: '#64748B' }}>
              Satellite-based fire & pollution mapping
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="p-3 rounded-lg text-center" style={{ backgroundColor: 'rgba(239, 68, 68, 0.08)' }}>
          <p className="text-xs font-semibold mb-1" style={{ color: '#64748B' }}>Active</p>
        ...
        <div className="p-3 rounded-lg text-center" style={{ backgroundColor: 'rgba(251, 191, 36, 0.08)' }}>
          <p className="text-xs font-semibold mb-1" style={{ color: '#64748B' }}>Clusters</p>
        ...
        <div className="p-3 rounded-lg text-center" style={{ backgroundColor: 'rgba(34, 197, 94, 0.08)' }}>
          <p className="text-xs font-semibold mb-1" style={{ color: '#64748B' }}>Coverage</p>
          <p className="text-lg font-bold" style={{ color: '#22C55E' }}>NCR</p>
        </div>
      </div>

      <div className="flex items-center gap-2 text-sm" style={{ color: '#64748B' }}>
        <Flame className="w-4 h-4" />
        <span>Real-time NASA FIRMS data</span>
      </div>
    </motion.div>
  );
}
