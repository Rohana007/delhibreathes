...
import { adminAuth } from '../../admin/api/adminApi';
import AdminAccessCode from '../../admin/components/AdminAccessCode';

export default function PolicyLogin() {
            ...
            <>
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-sm" style={{ color: '#64748B' }}>
                  Sign in to access policy dashboard
                </p>
              </div>
